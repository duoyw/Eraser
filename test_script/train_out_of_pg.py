...
class LeroHelper():
    ...
    def start(self, pool_num):
        ...
        # if (os.path.exists(self.output_query_latency_file)):
        #     os.remove(self.output_query_latency_file)
        # if (os.path.exists(self.output_query_latency_file + "_exploratory")):
        #     os.remove(self.output_query_latency_file + "_exploratory")
    ...
    def retrain(self, model_name):
        ...
        qid_list = []
        for i in range((TRAIN_STATS_NUM-1)*250,TRAIN_STATS_NUM*250,1):
            qid = "q" + str(i)
        qid_list.append(qid)
...
if __name__ == "__main__":
    ...
    if algo == "pg":
        ...
        queries_list = []
        with open(OUTPUT_QUERY_LATENCY_FILE_PG,'r') as f:
            lines = f.readlines()
            for line in lines:
        ...
        if (os.path.exists(OUTPUT_QUERY_LATENCY_FILE_PG)):
            os.remove(OUTPUT_QUERY_LATENCY_FILE_PG)

        with open(OUTPUT_QUERY_LATENCY_FILE_PG,'w') as f:
