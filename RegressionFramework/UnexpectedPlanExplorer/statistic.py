...
from RegressionFramework.Plan.Plan import PlanNode, JoinPlanNode, Plan
from RegressionFramework.UnexpectedPlanExplorer.histogram import Histogram
from RegressionFramework.SegmentModel.StaticPlanGroup import StaticPlanGroup
...
class Statistic:
    ...
    def build_train(self,plans, sqls):
        self.statistic_train.build(plans, sqls)
...
class StatisticTest:
    ...
    def is_shifted(self, plan: Plan):
        ...
        if self.filter_enable:
            existed_cols = set(self.statistic_train.get_all_cols())
